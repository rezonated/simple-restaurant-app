...
public class editPesanan extends javax.swing.JFrame {
    ...
    public ArrayList ListUsers() {
        ArrayList<pesanan> list = mr.getList();
        return list;
    }

    public void addRowToJTable() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        ArrayList<pesanan> list = ListUsers();
        Object rowData[] = new Object[list.size()];
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).menus;
            rowData[1] = list.get(i).hargas;
            rowData[2] = list.get(i).qtys;
            rowData[3] = list.get(i).bawapulangs;
